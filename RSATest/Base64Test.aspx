<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Base64Test.aspx.cs" Inherits="RSATest.Base64Test" %>
...
<head runat="server">
    <title></title>
     ...
     <script type="text/javascript" src="Scripts/Common.Utility.js"></script>
    ...
    <script type="text/javascript">
        function Encryt() {
            ...
            var encrytedString = bsrsa(modulus, exponent, source, true);
